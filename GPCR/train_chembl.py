...
if __name__ =="__main__":
    ...
    parser.add_argument('--val_data', type=str, default='/raid/home/yoyowu/transformerCPI/dataset/hmdb/Feb_13_23_dev_test/dev_37.tsv', help='validation data path')
    parser.add_argument('--test_data', type=str, default='/raid/home/yoyowu/transformerCPI/dataset/hmdb/Feb_13_23_dev_test/test_37.tsv', help='test data path')
    ...
    num_workers = 40  # Adjust based on your system's capabilities
    ...
    val_dataloader = DataLoader(val_dataset, batch_size=args.batch, shuffle=False, num_workers=num_workers, drop_last=False, collate_fn=collate_fn)
    test_dataset = ProteinCompoundDataset(test_data, hmdb_smiles_mapping, hmdb_protein_seq_mapping, hmdb_uniprot_mapping)
    test_dataloader = DataLoader(test_dataset, batch_size=args.batch, shuffle=False, num_workers=num_workers, drop_last=False, collate_fn=collate_fn)
    ...
    trainer = Trainer(model, lr, weight_decay, args.batch)
    tester = Tester(model)
    ...
    for epoch in range(1, args.iteration+1):
        ...
        # AUC_tr, PRC_tr = tester.test(dataloader, device)
